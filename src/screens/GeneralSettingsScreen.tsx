      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.content}>
            ...
            <View style={styles.themeRow}>
              <TouchableOpacity
                ...
                <Icon
                  name="moon"
                  size={18}
                  color={themeMode === 'dark' ? colors.bg : colors.textMuted}
                />
                <Text
                  style={[
                    styles.themeTxt,
                    { color: colors.textMuted },
                    themeMode === 'dark' && { color: colors.bg },
                  ]}>
              ...
              <TouchableOpacity
                ...
                <Icon
                  name="sunny"
                  size={18}
                  color={themeMode === 'light' ? colors.bg : colors.textMuted}
                />
                <Text
                  style={[
                    styles.themeTxt,
                    { color: colors.textMuted },
                    themeMode === 'light' && { color: colors.bg },
                  ]}>
              ...
              <TouchableOpacity
                ...
                <Icon
                  ...
                  size={18}
                  color={themeMode === 'system' ? colors.bg : colors.textMuted}
                />
                <Text
                  style={[
                    styles.themeTxt,
                    { color: colors.textMuted },
                    themeMode === 'system' && { color: colors.bg },
                  ]}>
        ...
        <View style={styles.section}>
          ...
          {showLangPicker && (
            <View
              style={[
                styles.card,
                { backgroundColor: colors.bgCard, borderColor: colors.border, marginTop: 8 },
              ]}>
              {SUPPORTED_LANGUAGES.map((lang, i) => (
                <TouchableOpacity
                  ...
                  <Text
                    style={{
                      fontSize: sizes.md,
                      color: currentLang === lang.code ? colors.accent : colors.textPrimary,
            ...
            <View style={styles.switchRow}>
              <View style={{ flex: 1 }}>
                <Text style={[styles.switchLabel, { color: colors.textPrimary }]}>
                  {t('settings.playback.hideDuplicates')}
                </Text>
                <Text
                  style={{ fontSize: 11, color: colors.textMuted, marginTop: 2, lineHeight: 16 }}>
                  {t('settings.playback.hideDuplicatesDesc')}
                </Text>
              </View>
              <Switch
                ...
                onValueChange={(v: boolean) => {
                  ...
                  if (v) {
                    ...
                    if (removedCount > 0) {
                      Alert.alert(
                        t('settings.playback.dedupeCompleteTitle'),
                        t('settings.playback.dedupeMessage', {
                          count: removedCount,
                          total: dedupedCount,
                        }),
                      );
        ...
        <View style={styles.section}>
          ...
          <View
                ...
                <TouchableOpacity
                  ...
                  <Text
                    style={[
                      styles.optionTxt,
                      { color: colors.textMuted },
                      lyricFontSize === fs && { color: colors.accent },
                    ]}>
                    {fs}
                  </Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  <Text
                    style={[
                      styles.optionTxt,
                      { color: colors.textMuted },
                      lyricLineHeight === lh && { color: colors.accent },
                    ]}>
                    {lh}
                  </Text>
                </TouchableOpacity>
            ...
            <TouchableOpacity
              style={[styles.resetBtn, { backgroundColor: colors.bgElevated }]}
              onPress={() => saveLyricSettings(16, 52)}>
              <Text style={{ fontSize: sizes.sm, color: colors.textMuted }}>
                {t('settings.lyrics.reset')}
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View
            ...
            <View style={styles.switchRow}>
              <View style={{ flex: 1 }}>
                <Text style={[styles.switchLabel, { color: colors.textPrimary }]}>
                  {t('settings.lyrics.btLyrics')}
                </Text>
                <Text
                  style={{ fontSize: 11, color: colors.textMuted, marginTop: 2, lineHeight: 16 }}>
                  {t('settings.lyrics.btLyricsDesc')}
                </Text>
              </View>
              <Switch
